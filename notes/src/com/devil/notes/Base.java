...
public abstract class Base extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dLayout.setDrawerShadow(R.drawable.drawer, GravityCompat.START);
		...
		listViewLTR.setAdapter(new ArrayAdapter<String>(this, R.layout.row,
				dareList));
		// listViewLTR.setOnItemClickListener(new
		// DrawerItemClickListener(this));

		getActionBar().setDisplayHomeAsUpEnabled(true);
		getActionBar().setHomeButtonEnabled(true);

		toggle = new ActionBarDrawerToggle(this, dLayout, R.drawable.drawer,
		 ...
		 * DrawerItemClickListener(this).selectItem(2); }
		 */
	}
