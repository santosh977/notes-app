...
ImageSwitcher is;
	...
	Button btnbk,btnfr,b,b1;
	 ...
	 // ,btnStart,btnStop 
	  ...
	  in=AnimationUtils.loadAnimation(getApplicationContext(), android.R.anim.slide_in_left);
	  out=AnimationUtils.loadAnimation(getApplicationContext(),android.R.anim.slide_out_right);
