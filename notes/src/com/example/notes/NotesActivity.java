...
/*
 * extends FragmentActivity implements ActionBar.TabListener { private ViewPager
 * viewPager; private TabsPagerAdapter mAdapter; private ActionBar actionBar; //
 * Tab titles private String[] tabs = { "Notes", "QuesPaper", "Projects" };
 * 
 * @SuppressLint("NewApi")
 * 
 * @Override protected void onCreate(Bundle savedInstanceState) {
 * super.onCreate(savedInstanceState); setContentView(R.layout.notes);
 * 
 * // Initialization viewPager = (ViewPager) findViewById(R.id.pager); actionBar
 ...
 * 
 * @Override public void onPageSelected(int position) { // on changing the page
 ...
 * 
 * @Override public void onTabSelected(Tab tab, FragmentTransaction ft) { // on
 * tab selected // show respected fragment view
