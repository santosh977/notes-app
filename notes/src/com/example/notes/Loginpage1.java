...
public class Loginpage1 extends Activity {
	...
	/*private static final String TAG_EMAIL = "userid";
...
public void ResultGet()
{
	...
	public void Function8(View v) {
		...
		if (!isValidPassword(Pass)) {
			...
			urlquery= new String(urlquery + "?userid="+(((EditText) findViewById(R.id.EditMail))
					.getText()).toString()+"&upass="+(((EditText) findViewById(R.id.Editpass)).getText())
			.toString());
