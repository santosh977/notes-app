...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    Users getContact(int id) {
        ...
        Cursor cursor = db.query(TABLE_CONTACTS, new String[] { 
                KEY_NAME,KEY_BRANCH,KEY_YEAR,KEY_SEMESTER, KEY_COLLEGE,KEY_CITY,KEY_EMAIL,KEY_PASSWORD }, KEY_NAME + "=?",
                new String[] { String.valueOf(id) }, null, null, null, null);
        if (cursor != null)
            cursor.moveToFirst();
 
        Users contact = new Users(cursor.getString(0),cursor.getString(1),Integer.parseInt(cursor.getString(2)),
    ...
    public int updateContact(Users users) {
        ...
        values.put(KEY_CITY, users.getCity()); //  Name
        values.put(KEY_EMAIL, users.getEmail()); //  Name
        values.put(KEY_EMAIL, users.getPassword()); 
        // updating row
